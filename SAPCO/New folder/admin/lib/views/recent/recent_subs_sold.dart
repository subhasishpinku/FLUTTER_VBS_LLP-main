...
import 'package:admin/models/subs_sold_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';

class RecentSubsSold extends StatelessWidget {
  RecentSubsSold({
    Key? key,
    this.userInfo,
  }) : super(key: key);
        ...
        children: [
          Row(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                onPressed: () {},
                child: Text("All Subscriptions Sold", overflow: TextOverflow.ellipsis,),
              ),
            ],
          ),
          SizedBox(
          ...
          SizedBox(
            ...
            child: ListView.separated(
                ...
                shrinkWrap: true,
                itemCount: subscriptionSoldModel.length,
                      ...
                      children: [
                        Expanded(
                          child: SvgPicture.asset(
                            subscriptionSoldModel[i]['img'],
                            height: 30,
                            width: 30,
                          ),
                        ),
                        // SizedBox(width: 10,),
                        Expanded(child: Text(subscriptionSoldModel[i]['name'])),
                        // Padding(
                        ...
                        Expanded(child: Text(subscriptionSoldModel[i]['date'])),
                        Expanded(child: Text(subscriptionSoldModel[i]['count'])),
                      ],
                    ),
                  );
                }),
