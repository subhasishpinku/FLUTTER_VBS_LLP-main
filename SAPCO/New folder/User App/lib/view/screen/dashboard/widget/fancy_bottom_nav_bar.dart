...
class FancyBottomNavBarState extends State<FancyBottomNavBar> with TickerProviderStateMixin, RouteAware 
{
			...
			[
				...
				(
					...
					(
						...
						children: widget.tabs.map((t) => TabItem
						(
							uniqueKey: t.key,
									...
									(
										...
										[
											...
											(
												height: ARC_HEIGHT,
												width: ARC_WIDTH,
												child: CustomPaint(painter: HalfPainter(barBackgroundColor))
											),
                        					SizedBox
											(
												height: CIRCLE_SIZE,
