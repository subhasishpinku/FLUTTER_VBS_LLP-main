...
import 'package:sreeleathers/view/screen/onboarding/onboarding_screen.dart';
import 'package:sreeleathers/view/screen/splash/widget/splash_painter.dart';
    	...
    	Provider.of<SplashProvider>(context, listen: false).initConfig(context).then((bool isSuccess)
		{
      		if(isSuccess)
			{
        		...
        		Timer(Duration(seconds: 1), ()
				{
					...
					{
            			Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (BuildContext context) => OnBoardingScreen(indicatorColor: ColorResources.GREY, selectedIndicatorColor: ColorResources.COLOR_PRIMARY)));
          			}
        		});
      		}
    	});
