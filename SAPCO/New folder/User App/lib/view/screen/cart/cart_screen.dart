...
import 'package:sreeleathers/view/screen/cart/widget/cart_widget.dart';
							...
							(
              					onPressed: () 
								{
                					if(Provider.of<AuthProvider>(context, listen: false).isLoggedIn()) 
									{
										...
										{
                    						if (Provider.of<CartProvider>(context, listen: false).isSelectedList[i]) 
											{
												cartList.add(Provider.of<CartProvider>(context, listen: false).cartList[i]);
                    						}
                  						}
