...
import 'package:sreeleathers/view/screen/product/widget/seller_view.dart';
...
import 'package:sreeleathers/view/screen/product/widget/bottom_cart_view.dart';
import 'package:sreeleathers/view/screen/product/widget/product_image_view.dart';
import 'package:sreeleathers/view/screen/product/widget/product_specification_view.dart';
import 'package:sreeleathers/view/screen/product/widget/product_title_view.dart';
import 'package:sreeleathers/view/screen/product/widget/related_product_view.dart';
										...
										[
											...
											(
												...
												[
													...
													Text
													(
														Strings.details, style: titilliumRegular.copyWith(
								...
								(
									...
									(
										...
										[
											TitleRow
											(
												title: getTranslated('reviews', context)+'(${details.reviewList != null ? details.reviewList.length : 0})', isDetailsPage: true, 
												onTap: () 
												{
