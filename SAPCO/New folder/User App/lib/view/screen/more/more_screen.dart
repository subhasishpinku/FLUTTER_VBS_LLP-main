...
import 'package:sreeleathers/view/screen/chat/inbox_screen.dart';
...
import 'package:sreeleathers/view/screen/category/all_category_screen.dart';
import 'package:sreeleathers/view/screen/more/web_view_screen.dart';
import 'package:sreeleathers/view/screen/more/widget/app_info_dialog.dart';
import 'package:sreeleathers/view/screen/more/widget/sign_out_confirmation_dialog.dart';
import 'package:sreeleathers/view/screen/notification/notification_screen.dart';
import 'package:sreeleathers/view/screen/offer/offers_screen.dart';
import 'package:sreeleathers/view/screen/order/order_screen.dart';
import 'package:sreeleathers/view/screen/profile/address_list_screen.dart';
import 'package:sreeleathers/view/screen/profile/profile_screen.dart';
import 'package:sreeleathers/view/screen/setting/settings_screen.dart';
import 'package:sreeleathers/view/screen/support/support_ticket_screen.dart';
import 'package:sreeleathers/view/screen/wishlist/wishlist_screen.dart';
import 'package:sreeleathers/view/wallet/wallet.dart';
				...
				[
					...
					(
						...
						(
							...
							{
								print('${Provider.of<SplashProvider>(context, listen: false).configModel.staticUrls.termsConditions}');
								return Row
								(
									children:
									[
										...
										(
											...
											(
												...
												[
													Text
													(
														!isGuestMode ? profile.userInfoModel != null ? '${profile.userInfoModel.fName} ${profile.userInfoModel.lName}' : 'Full Name' : 'Guest',
														...
														: profile.userInfoModel == null
															...
															(
																...
																(
																	...
																	height: 35,
																	fit: BoxFit.fill,
																	// image: "https://images.pexels.com/photos/4652060/pexels-photo-4652060.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
						...
						(
							...
							(
								...
								[
									...
									TitleButton(image: Images.wallet, title: getTranslated('wallet', context), navigateTo: WalletScreen()),
									TitleButton
									(
