...
import 'package:sreeleathers/view/screen/product/brand_and_category_product_screen.dart';
								...
								[
									...
									(
										...
										(
											...
											(
												radius: 30,
												backgroundImage: NetworkImage(Provider.of<SplashProvider>(context,listen: false).baseUrls.brandImageUrl + '/' + brandProvider.brandList[index].image.toString())
											)
										)
                  					),
									SizedBox
					...
					(
						...
						[
							...
							(
								child: Container
								(
									decoration: BoxDecoration(color: ColorResources.WHITE, shape: BoxShape.circle)
								)
							),
