	...
	Widget build(BuildContext context)
	{
		...
		(
			builder: (context, bannerProvider, child)
			{
				...
				print(bannerProvider.mainBannerList);
										...
										(
											...
											(
												...
												(
													...
													image: '${Provider.of<SplashProvider>(context,listen: false).baseUrls.bannerImageUrl}''/${bannerProvider.mainBannerList[index].photo}',
													fit: BoxFit.cover,
												),
											),
										),
