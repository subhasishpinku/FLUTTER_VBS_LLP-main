...
import 'package:sreeleathers/view/screen/product/product_details_screen.dart';
...
class ProductWidget extends StatelessWidget
{
	...
	Widget build(BuildContext context)
	{
		...
		(
			onTap: ()
			{
				Navigator.push(context, PageRouteBuilder(transitionDuration: Duration(milliseconds: 1000), pageBuilder: (context, anim1, anim2) => ProductDetails(product: productModel)));
			},
			child: Container
			(
