import 'package:sreeleathers/data/model/response/language_model.dart';

class AppConstants 
{
	//   static const String BASE_URL = 'https://demo.6amtech.com/6.valley/';
  	static const String BASE_URL = 'https://development.lifeproductions.in/sreelathers/';
	...
	static const String SEND_OTP = 'api/v1/auth/otp-login';
	static const String VERIFY_OTP = 'api/v1/auth/otp-login-verification';
	...
	static const String TOPIC = 'sreeleathers';
