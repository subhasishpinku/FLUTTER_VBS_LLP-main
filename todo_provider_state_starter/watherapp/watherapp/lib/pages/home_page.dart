...
import 'package:watherapp/repositories/weather_repository.dart';
import 'package:watherapp/services/weather_api_services.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  _fetchWeather() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<WeatherProvider>().fetchWeather('kolkata');
    });
  }
