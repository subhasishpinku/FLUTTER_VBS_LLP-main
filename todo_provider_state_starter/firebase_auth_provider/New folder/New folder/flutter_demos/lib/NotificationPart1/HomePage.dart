...
// import 'package:flutter_demos/NotificationPart1/InfoValueString.dart';
...
//   final ByteData assetIcon =
//       await rootBundle.load('icons/app_icon_density.png');

//   // Decode the image data
//   final ui.Image? iconData =
//       await decodeImageFromList(assetIcon.buffer.asUint8List());

//   if (iconData != null) {
//     // Convert the image data to ByteData
//     final ByteData? byteData = await iconData.toByteData();

//     if (byteData != null) {
//       // Convert ByteData to Uint8List
//       final Uint8List iconBytes = byteData.buffer.asUint8List();

//       // Create LinuxRawIconData using the icon bytes and dimensions
//       final LinuxRawIconData rawIconData = LinuxRawIconData(
//         data: iconBytes,
//         width: iconData.width,
//         height: iconData.height,
//         channels: 4, // Assuming 4 channels (RGBA)
//         hasAlpha: true, // The icon has an alpha channel
//       );

//       // Create ByteDataLinuxIcon using LinuxRawIconData
//       final ByteDataLinuxIcon linuxIcon = ByteDataLinuxIcon(rawIconData);

//       // Create LinuxNotificationDetails using ByteDataLinuxIcon
//       final LinuxNotificationDetails linuxPlatformChannelSpecifics =
//           LinuxNotificationDetails(icon: linuxIcon);
...
// //   );
// //   var image;
// //   final ui.Image? iconData = image.decodePng(
