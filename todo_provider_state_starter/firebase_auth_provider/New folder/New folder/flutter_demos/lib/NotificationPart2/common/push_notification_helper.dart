...
import 'package:flutter_demos/NotificationPart2/view/data_view.dart';
import 'package:flutter_demos/NotificationPart2/view/detail_view.dart';
...
void openNotification(Map payloadObj) async {
  ...
  if (payloadObj["user_login_need"].toString() == "true") {
    if (Globs.udValueBool(Globs.userLogin)) {
      ...
      if (payloadObj["user_id"].toString() ==
