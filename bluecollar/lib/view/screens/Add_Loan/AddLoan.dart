        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              textfield("Start Date", suffixicon: Icons.calendar_month),
              SizedBox(
                height: 10,
              ),
              textfield("Amount"),
              ...
              textfield("Monthly Deduction"),
              SizedBox(
                height: 10,
              ),
              textfield("Payment Start Date", suffixicon: Icons.calendar_month),
              SizedBox(
                height: 10,
              ),
              Center(
